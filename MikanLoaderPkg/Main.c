...
EFI_STATUS OpenRootDir(EFI_HANDLE image_handle, EFI_FILE_PROTOCOL** root){
    ...
    gBS->OpenProtocol(image_handle, &gEfiLoadedImageProtocolGuid,
        (VOID**)&loaded_image, image_handle,
        NULL, EFI_OPEN_PROTOCOL_BY_HANDLE_PROTOCOL);

    gBS->OpenProtocol(loaded_image->DeviceHandle, &gEfiSimpleFileSystemProtocolGuid,
        (VOID**)&fs, image_handle,
        NULL, EFI_OPEN_PROTOCOL_BY_HANDLE_PROTOCOL);
...
EFI_STATUS OpenGOP(EFI_HANDLE image_handle, EFI_GRAPHICS_OUTPUT_PROTOCOL** gop){
	...
	gBS->OpenProtocol(gop_handles[0], &gEfiGraphicsOutputProtocolGuid,
		(VOID**)gop, image_handle, NULL, EFI_OPEN_PROTOCOL_BY_HANDLE_PROTOCOL);
...
EFI_STATUS EFIAPI UefiMain(EFI_HANDLE image_handle, EFI_SYSTEM_TABLE *system_table){
	...
	Print(L"Frame Buffer: 0x0lx - 0x%0lx, Size: %lu bytes\n",
